// src/app/admin/pricing/[id]/edit/page.js
"use client";
      ...
      try {
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            price: item.price || "",
            period: item.period || "ماهانه",
            features: item.features || [],
            image: item.image || "",
            badge: item.badge || "",
            buttonText: item.buttonText || "ثبت نام",
            color: item.color || "#440099",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.message || "خطا در ویرایش پلن");
      }
    } catch (err) {
      setError("مشکل در ارتباط با سرور");
    } finally {
  ...
  return (
    <>
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>✏️ ویرایش پلن</h1>
      ...
      >
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            ...
            >
              <FaUpload />
              {imagePreview ? "تغییر عکس" : "انتخاب عکس از دستگاه"}
              <input
                type="file"
                accept="image/*"
